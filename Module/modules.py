...
class SeparableConv2d(nn.Module):
    def __init__(self, c_in: int, c_out: int, kernel_size: int, padding: Union[int, tuple] = 0):
        ...
        self.kernel_size = kernel_size
        self.padding = padding
        self.depthwise_conv = nn.Conv2d(self.c_in, self.c_in, kernel_size=(1, self.kernel_size),
                                        padding=(0, self.padding), groups=self.c_in)
        self.conv1d_1x1 = nn.Conv2d(self.c_in, self.c_out, kernel_size=(1,1))
